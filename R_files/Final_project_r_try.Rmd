...
dataX <- eh21v %>%mutate (luz = (s07a_16 == 2) , agua =(s07a_10 == 7 | s07a_10 == 8),
...
correlations <- cor(dataProject)              
corrplot(correlations, method="number", order="hclust", type="lower")




m1 <- lm(s01a_02 ~ ylab  +factor(aestudio)+factor(area) +
           s01a_03+factor(s07a_10)+factor(s01a_09)+ dis+factor(s07a_16)+
           sueldo + luz, data= dataProject)
